...
public class AddGuildSlashCommands {
    ...
    public void addAutomodCommands() {
        guild.updateCommands().addCommands(
                ...
                Commands.slash("automod-clear-violations", "Clear all violations for a specific user")
                        .addOption(OptionType.USER, "user", "User whose violations to clear", true),
                Commands.slash("automod-top-violators", "View users with the most automod violations")
                        .addOption(OptionType.INTEGER, "days", "Number of days to look back (1-30, default: 7)", false)
                        .addOption(OptionType.INTEGER, "limit", "Maximum number of users to show (1-20, default: 10)", false)
        ).queue();
    }
